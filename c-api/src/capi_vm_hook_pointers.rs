...
pub struct vm_exec_vm_hook_c_func_pointers {
    ...
    pub get_dcdt_balance_func_ptr: extern "C" fn(context: *mut c_void, address_offset: i32, token_id_offset: i32, token_id_len: i32, nonce: i64, result_offset: i32) -> i32,
    pub get_dcdt_nft_name_length_func_ptr: extern "C" fn(context: *mut c_void, address_offset: i32, token_id_offset: i32, token_id_len: i32, nonce: i64) -> i32,
    pub get_dcdt_nft_attribute_length_func_ptr: extern "C" fn(context: *mut c_void, address_offset: i32, token_id_offset: i32, token_id_len: i32, nonce: i64) -> i32,
    pub get_dcdt_nft_uri_length_func_ptr: extern "C" fn(context: *mut c_void, address_offset: i32, token_id_offset: i32, token_id_len: i32, nonce: i64) -> i32,
    pub get_dcdt_token_data_func_ptr: extern "C" fn(context: *mut c_void, address_offset: i32, token_id_offset: i32, token_id_len: i32, nonce: i64, value_handle: i32, properties_offset: i32, hash_offset: i32, name_offset: i32, attributes_offset: i32, creator_offset: i32, royalties_handle: i32, uris_offset: i32) -> i32,
    pub get_dcdt_local_roles_func_ptr: extern "C" fn(context: *mut c_void, token_id_handle: i32) -> i64,
    ...
    pub transfer_dcdt_execute_func_ptr: extern "C" fn(context: *mut c_void, dest_offset: i32, token_id_offset: i32, token_id_len: i32, value_offset: i32, gas_limit: i64, function_offset: i32, function_length: i32, num_arguments: i32, arguments_length_offset: i32, data_offset: i32) -> i32,
    pub transfer_dcdt_nft_execute_func_ptr: extern "C" fn(context: *mut c_void, dest_offset: i32, token_id_offset: i32, token_id_len: i32, value_offset: i32, nonce: i64, gas_limit: i64, function_offset: i32, function_length: i32, num_arguments: i32, arguments_length_offset: i32, data_offset: i32) -> i32,
    pub multi_transfer_dcdt_nft_execute_func_ptr: extern "C" fn(context: *mut c_void, dest_offset: i32, num_token_transfers: i32, token_transfers_args_length_offset: i32, token_transfer_data_offset: i32, gas_limit: i64, function_offset: i32, function_length: i32, num_arguments: i32, arguments_length_offset: i32, data_offset: i32) -> i32,
    ...
    pub get_dcdt_value_func_ptr: extern "C" fn(context: *mut c_void, result_offset: i32) -> i32,
    pub get_dcdt_value_by_index_func_ptr: extern "C" fn(context: *mut c_void, result_offset: i32, index: i32) -> i32,
    pub get_dcdt_token_name_func_ptr: extern "C" fn(context: *mut c_void, result_offset: i32) -> i32,
    pub get_dcdt_token_name_by_index_func_ptr: extern "C" fn(context: *mut c_void, result_offset: i32, index: i32) -> i32,
    pub get_dcdt_token_nonce_func_ptr: extern "C" fn(context: *mut c_void) -> i64,
    pub get_dcdt_token_nonce_by_index_func_ptr: extern "C" fn(context: *mut c_void, index: i32) -> i64,
    pub get_current_dcdt_nft_nonce_func_ptr: extern "C" fn(context: *mut c_void, address_offset: i32, token_id_offset: i32, token_id_len: i32) -> i64,
    pub get_dcdt_token_type_func_ptr: extern "C" fn(context: *mut c_void) -> i32,
    pub get_dcdt_token_type_by_index_func_ptr: extern "C" fn(context: *mut c_void, index: i32) -> i32,
    pub get_num_dcdt_transfers_func_ptr: extern "C" fn(context: *mut c_void) -> i32,
    ...
    pub managed_get_multi_dcdt_call_value_func_ptr: extern "C" fn(context: *mut c_void, multi_call_value_handle: i32),
    pub managed_get_all_transfers_call_value_func_ptr: extern "C" fn(context: *mut c_void, transfer_call_values_list_handle: i32),
    pub managed_get_back_transfers_func_ptr: extern "C" fn(context: *mut c_void, dcdt_transfers_value_handle: i32, rewa_value_handle: i32),
    pub managed_get_dcdt_balance_func_ptr: extern "C" fn(context: *mut c_void, address_handle: i32, token_id_handle: i32, nonce: i64, value_handle: i32),
    pub managed_get_dcdt_token_data_func_ptr: extern "C" fn(context: *mut c_void, address_handle: i32, token_id_handle: i32, nonce: i64, value_handle: i32, properties_handle: i32, hash_handle: i32, name_handle: i32, attributes_handle: i32, creator_handle: i32, royalties_handle: i32, uris_handle: i32),
    pub managed_get_dcdt_token_type_func_ptr: extern "C" fn(context: *mut c_void, address_handle: i32, token_id_handle: i32, nonce: i64, type_handle: i32),
    ...
    pub managed_multi_transfer_dcdt_nft_execute_func_ptr: extern "C" fn(context: *mut c_void, dst_handle: i32, token_transfers_handle: i32, gas_limit: i64, function_handle: i32, arguments_handle: i32) -> i32,
    pub managed_multi_transfer_dcdt_nft_execute_with_return_func_ptr: extern "C" fn(context: *mut c_void, dst_handle: i32, token_transfers_handle: i32, gas_limit: i64, function_handle: i32, arguments_handle: i32) -> i32,
    pub managed_multi_transfer_dcdt_nft_execute_by_user_func_ptr: extern "C" fn(context: *mut c_void, user_handle: i32, dst_handle: i32, token_transfers_handle: i32, gas_limit: i64, function_handle: i32, arguments_handle: i32) -> i32,
    ...
    pub managed_is_dcdt_frozen_func_ptr: extern "C" fn(context: *mut c_void, address_handle: i32, token_id_handle: i32, nonce: i64) -> i32,
    pub managed_is_dcdt_limited_transfer_func_ptr: extern "C" fn(context: *mut c_void, token_id_handle: i32) -> i32,
    pub managed_is_dcdt_paused_func_ptr: extern "C" fn(context: *mut c_void, token_id_handle: i32) -> i32,
    ...
    pub big_int_get_dcdt_call_value_func_ptr: extern "C" fn(context: *mut c_void, destination: i32),
    pub big_int_get_dcdt_call_value_by_index_func_ptr: extern "C" fn(context: *mut c_void, destination_handle: i32, index: i32),
    pub big_int_get_external_balance_func_ptr: extern "C" fn(context: *mut c_void, address_offset: i32, result: i32),
    pub big_int_get_dcdt_external_balance_func_ptr: extern "C" fn(context: *mut c_void, address_offset: i32, token_id_offset: i32, token_id_len: i32, nonce: i64, result_handle: i32),
