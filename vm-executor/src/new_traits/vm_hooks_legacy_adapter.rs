...
impl<VH: VMHooksSetEarlyExit> VMHooksLegacy for VMHooksLegacyAdapter<VH> {
    ...
    fn get_dcdt_balance(&self, address_offset: MemPtr, token_id_offset: MemPtr, token_id_len: MemLength, nonce: i64, result_offset: MemPtr) -> i32 {
        self.adapt_vm_hooks(|inner| VMHooks::get_dcdt_balance(inner, address_offset, token_id_offset, token_id_len, nonce, result_offset))
    }

    fn get_dcdt_nft_name_length(&self, address_offset: MemPtr, token_id_offset: MemPtr, token_id_len: MemLength, nonce: i64) -> i32 {
        self.adapt_vm_hooks(|inner| VMHooks::get_dcdt_nft_name_length(inner, address_offset, token_id_offset, token_id_len, nonce))
    }

    fn get_dcdt_nft_attribute_length(&self, address_offset: MemPtr, token_id_offset: MemPtr, token_id_len: MemLength, nonce: i64) -> i32 {
        self.adapt_vm_hooks(|inner| VMHooks::get_dcdt_nft_attribute_length(inner, address_offset, token_id_offset, token_id_len, nonce))
    }

    fn get_dcdt_nft_uri_length(&self, address_offset: MemPtr, token_id_offset: MemPtr, token_id_len: MemLength, nonce: i64) -> i32 {
        self.adapt_vm_hooks(|inner| VMHooks::get_dcdt_nft_uri_length(inner, address_offset, token_id_offset, token_id_len, nonce))
    }
    ...
    fn get_dcdt_token_data(&self, address_offset: MemPtr, token_id_offset: MemPtr, token_id_len: MemLength, nonce: i64, value_handle: i32, properties_offset: MemPtr, hash_offset: MemPtr, name_offset: MemPtr, attributes_offset: MemPtr, creator_offset: MemPtr, royalties_handle: i32, uris_offset: MemPtr) -> i32 {
        self.adapt_vm_hooks(|inner| VMHooks::get_dcdt_token_data(inner, address_offset, token_id_offset, token_id_len, nonce, value_handle, properties_offset, hash_offset, name_offset, attributes_offset, creator_offset, royalties_handle, uris_offset))
    }

    fn get_dcdt_local_roles(&self, token_id_handle: i32) -> i64 {
        self.adapt_vm_hooks(|inner| VMHooks::get_dcdt_local_roles(inner, token_id_handle))
    }
    ...
    fn transfer_dcdt_execute(&self, dest_offset: MemPtr, token_id_offset: MemPtr, token_id_len: MemLength, value_offset: MemPtr, gas_limit: i64, function_offset: MemPtr, function_length: MemLength, num_arguments: i32, arguments_length_offset: MemPtr, data_offset: MemPtr) -> i32 {
        self.adapt_vm_hooks(|inner| VMHooks::transfer_dcdt_execute(inner, dest_offset, token_id_offset, token_id_len, value_offset, gas_limit, function_offset, function_length, num_arguments, arguments_length_offset, data_offset))
    }
    ...
    fn transfer_dcdt_nft_execute(&self, dest_offset: MemPtr, token_id_offset: MemPtr, token_id_len: MemLength, value_offset: MemPtr, nonce: i64, gas_limit: i64, function_offset: MemPtr, function_length: MemLength, num_arguments: i32, arguments_length_offset: MemPtr, data_offset: MemPtr) -> i32 {
        self.adapt_vm_hooks(|inner| VMHooks::transfer_dcdt_nft_execute(inner, dest_offset, token_id_offset, token_id_len, value_offset, nonce, gas_limit, function_offset, function_length, num_arguments, arguments_length_offset, data_offset))
    }
    ...
    fn multi_transfer_dcdt_nft_execute(&self, dest_offset: MemPtr, num_token_transfers: i32, token_transfers_args_length_offset: MemPtr, token_transfer_data_offset: MemPtr, gas_limit: i64, function_offset: MemPtr, function_length: MemLength, num_arguments: i32, arguments_length_offset: MemPtr, data_offset: MemPtr) -> i32 {
        self.adapt_vm_hooks(|inner| VMHooks::multi_transfer_dcdt_nft_execute(inner, dest_offset, num_token_transfers, token_transfers_args_length_offset, token_transfer_data_offset, gas_limit, function_offset, function_length, num_arguments, arguments_length_offset, data_offset))
    }
    ...
    fn get_dcdt_value(&self, result_offset: MemPtr) -> i32 {
        self.adapt_vm_hooks(|inner| VMHooks::get_dcdt_value(inner, result_offset))
    }

    fn get_dcdt_value_by_index(&self, result_offset: MemPtr, index: i32) -> i32 {
        self.adapt_vm_hooks(|inner| VMHooks::get_dcdt_value_by_index(inner, result_offset, index))
    }

    fn get_dcdt_token_name(&self, result_offset: MemPtr) -> i32 {
        self.adapt_vm_hooks(|inner| VMHooks::get_dcdt_token_name(inner, result_offset))
    }

    fn get_dcdt_token_name_by_index(&self, result_offset: MemPtr, index: i32) -> i32 {
        self.adapt_vm_hooks(|inner| VMHooks::get_dcdt_token_name_by_index(inner, result_offset, index))
    }

    fn get_dcdt_token_nonce(&self) -> i64 {
        self.adapt_vm_hooks(|inner| VMHooks::get_dcdt_token_nonce(inner))
    }

    fn get_dcdt_token_nonce_by_index(&self, index: i32) -> i64 {
        self.adapt_vm_hooks(|inner| VMHooks::get_dcdt_token_nonce_by_index(inner, index))
    }

    fn get_current_dcdt_nft_nonce(&self, address_offset: MemPtr, token_id_offset: MemPtr, token_id_len: MemLength) -> i64 {
        self.adapt_vm_hooks(|inner| VMHooks::get_current_dcdt_nft_nonce(inner, address_offset, token_id_offset, token_id_len))
    }

    fn get_dcdt_token_type(&self) -> i32 {
        self.adapt_vm_hooks(|inner| VMHooks::get_dcdt_token_type(inner))
    }

    fn get_dcdt_token_type_by_index(&self, index: i32) -> i32 {
        self.adapt_vm_hooks(|inner| VMHooks::get_dcdt_token_type_by_index(inner, index))
    }

    fn get_num_dcdt_transfers(&self) -> i32 {
        self.adapt_vm_hooks(|inner| VMHooks::get_num_dcdt_transfers(inner))
    }
    ...
    fn managed_get_multi_dcdt_call_value(&self, multi_call_value_handle: i32) {
        self.adapt_vm_hooks(|inner| VMHooks::managed_get_multi_dcdt_call_value(inner, multi_call_value_handle))
    }
    ...
    fn managed_get_back_transfers(&self, dcdt_transfers_value_handle: i32, rewa_value_handle: i32) {
        self.adapt_vm_hooks(|inner| VMHooks::managed_get_back_transfers(inner, dcdt_transfers_value_handle, rewa_value_handle))
    }

    fn managed_get_dcdt_balance(&self, address_handle: i32, token_id_handle: i32, nonce: i64, value_handle: i32) {
        self.adapt_vm_hooks(|inner| VMHooks::managed_get_dcdt_balance(inner, address_handle, token_id_handle, nonce, value_handle))
    }
    ...
    fn managed_get_dcdt_token_data(&self, address_handle: i32, token_id_handle: i32, nonce: i64, value_handle: i32, properties_handle: i32, hash_handle: i32, name_handle: i32, attributes_handle: i32, creator_handle: i32, royalties_handle: i32, uris_handle: i32) {
        self.adapt_vm_hooks(|inner| VMHooks::managed_get_dcdt_token_data(inner, address_handle, token_id_handle, nonce, value_handle, properties_handle, hash_handle, name_handle, attributes_handle, creator_handle, royalties_handle, uris_handle))
    }

    fn managed_get_dcdt_token_type(&self, address_handle: i32, token_id_handle: i32, nonce: i64, type_handle: i32) {
        self.adapt_vm_hooks(|inner| VMHooks::managed_get_dcdt_token_type(inner, address_handle, token_id_handle, nonce, type_handle))
    }
    ...
    fn managed_multi_transfer_dcdt_nft_execute(&self, dst_handle: i32, token_transfers_handle: i32, gas_limit: i64, function_handle: i32, arguments_handle: i32) -> i32 {
        self.adapt_vm_hooks(|inner| VMHooks::managed_multi_transfer_dcdt_nft_execute(inner, dst_handle, token_transfers_handle, gas_limit, function_handle, arguments_handle))
    }

    fn managed_multi_transfer_dcdt_nft_execute_with_return(&self, dst_handle: i32, token_transfers_handle: i32, gas_limit: i64, function_handle: i32, arguments_handle: i32) -> i32 {
        self.adapt_vm_hooks(|inner| VMHooks::managed_multi_transfer_dcdt_nft_execute_with_return(inner, dst_handle, token_transfers_handle, gas_limit, function_handle, arguments_handle))
    }
    ...
    fn managed_multi_transfer_dcdt_nft_execute_by_user(&self, user_handle: i32, dst_handle: i32, token_transfers_handle: i32, gas_limit: i64, function_handle: i32, arguments_handle: i32) -> i32 {
        self.adapt_vm_hooks(|inner| VMHooks::managed_multi_transfer_dcdt_nft_execute_by_user(inner, user_handle, dst_handle, token_transfers_handle, gas_limit, function_handle, arguments_handle))
    }
    ...
    fn managed_is_dcdt_frozen(&self, address_handle: i32, token_id_handle: i32, nonce: i64) -> i32 {
        self.adapt_vm_hooks(|inner| VMHooks::managed_is_dcdt_frozen(inner, address_handle, token_id_handle, nonce))
    }

    fn managed_is_dcdt_limited_transfer(&self, token_id_handle: i32) -> i32 {
        self.adapt_vm_hooks(|inner| VMHooks::managed_is_dcdt_limited_transfer(inner, token_id_handle))
    }

    fn managed_is_dcdt_paused(&self, token_id_handle: i32) -> i32 {
        self.adapt_vm_hooks(|inner| VMHooks::managed_is_dcdt_paused(inner, token_id_handle))
    }
    ...
    fn big_int_get_dcdt_call_value(&self, destination: i32) {
        self.adapt_vm_hooks(|inner| VMHooks::big_int_get_dcdt_call_value(inner, destination))
    }

    fn big_int_get_dcdt_call_value_by_index(&self, destination_handle: i32, index: i32) {
        self.adapt_vm_hooks(|inner| VMHooks::big_int_get_dcdt_call_value_by_index(inner, destination_handle, index))
    }
    ...
    fn big_int_get_dcdt_external_balance(&self, address_offset: MemPtr, token_id_offset: MemPtr, token_id_len: MemLength, nonce: i64, result_handle: i32) {
        self.adapt_vm_hooks(|inner| VMHooks::big_int_get_dcdt_external_balance(inner, address_offset, token_id_offset, token_id_len, nonce, result_handle))
    }
