...
#[rustfmt::skip]
fn wasmer_import_managed_get_dcdt_token_type(env: &VMHooksWrapper, address_handle: i32, token_id_handle: i32, nonce: i64, type_handle: i32) {
    env.vm_hooks.managed_get_dcdt_token_type(address_handle, token_id_handle, nonce, type_handle)
}
...
#[rustfmt::skip]
fn wasmer_import_managed_multi_transfer_dcdt_nft_execute_with_return(env: &VMHooksWrapper, dst_handle: i32, token_transfers_handle: i32, gas_limit: i64, function_handle: i32, arguments_handle: i32) -> i32 {
    env.vm_hooks.managed_multi_transfer_dcdt_nft_execute_with_return(dst_handle, token_transfers_handle, gas_limit, function_handle, arguments_handle)
}

#[rustfmt::skip]
fn wasmer_import_managed_multi_transfer_dcdt_nft_execute_by_user(env: &VMHooksWrapper, user_handle: i32, dst_handle: i32, token_transfers_handle: i32, gas_limit: i64, function_handle: i32, arguments_handle: i32) -> i32 {
    env.vm_hooks.managed_multi_transfer_dcdt_nft_execute_by_user(user_handle, dst_handle, token_transfers_handle, gas_limit, function_handle, arguments_handle)
}
...
pub fn generate_import_object(store: &Store, env: &VMHooksWrapper) -> ImportObject {
    imports! {
        "env" => {
            ...
            "managedGetDCDTTokenType" => Function::new_native_with_env(store, env.clone(), wasmer_import_managed_get_dcdt_token_type),
            ...
            "managedMultiTransferDCDTNFTExecuteWithReturn" => Function::new_native_with_env(store, env.clone(), wasmer_import_managed_multi_transfer_dcdt_nft_execute_with_return),
            "managedMultiTransferDCDTNFTExecuteByUser" => Function::new_native_with_env(store, env.clone(), wasmer_import_managed_multi_transfer_dcdt_nft_execute_by_user),
