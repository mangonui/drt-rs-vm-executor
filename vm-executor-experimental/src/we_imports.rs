...
#[rustfmt::skip]
fn wasmer_import_get_dcdt_balance(env: FunctionEnvMut<VMHooksWrapper>, address_offset: i32, token_id_offset: i32, token_id_len: i32, nonce: i64, result_offset: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_dcdt_balance(convert_mem_ptr(address_offset), convert_mem_ptr(token_id_offset), convert_mem_length(token_id_len), nonce, convert_mem_ptr(result_offset)))
}

#[rustfmt::skip]
fn wasmer_import_get_dcdt_nft_name_length(env: FunctionEnvMut<VMHooksWrapper>, address_offset: i32, token_id_offset: i32, token_id_len: i32, nonce: i64) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_dcdt_nft_name_length(convert_mem_ptr(address_offset), convert_mem_ptr(token_id_offset), convert_mem_length(token_id_len), nonce))
}

#[rustfmt::skip]
fn wasmer_import_get_dcdt_nft_attribute_length(env: FunctionEnvMut<VMHooksWrapper>, address_offset: i32, token_id_offset: i32, token_id_len: i32, nonce: i64) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_dcdt_nft_attribute_length(convert_mem_ptr(address_offset), convert_mem_ptr(token_id_offset), convert_mem_length(token_id_len), nonce))
}

#[rustfmt::skip]
fn wasmer_import_get_dcdt_nft_uri_length(env: FunctionEnvMut<VMHooksWrapper>, address_offset: i32, token_id_offset: i32, token_id_len: i32, nonce: i64) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_dcdt_nft_uri_length(convert_mem_ptr(address_offset), convert_mem_ptr(token_id_offset), convert_mem_length(token_id_len), nonce))
}

#[rustfmt::skip]
fn wasmer_import_get_dcdt_token_data(env: FunctionEnvMut<VMHooksWrapper>, address_offset: i32, token_id_offset: i32, token_id_len: i32, nonce: i64, value_handle: i32, properties_offset: i32, hash_offset: i32, name_offset: i32, attributes_offset: i32, creator_offset: i32, royalties_handle: i32, uris_offset: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_dcdt_token_data(convert_mem_ptr(address_offset), convert_mem_ptr(token_id_offset), convert_mem_length(token_id_len), nonce, value_handle, convert_mem_ptr(properties_offset), convert_mem_ptr(hash_offset), convert_mem_ptr(name_offset), convert_mem_ptr(attributes_offset), convert_mem_ptr(creator_offset), royalties_handle, convert_mem_ptr(uris_offset)))
}

#[rustfmt::skip]
fn wasmer_import_get_dcdt_local_roles(env: FunctionEnvMut<VMHooksWrapper>, token_id_handle: i32) -> Result<i64, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_dcdt_local_roles(token_id_handle))
}
...
#[rustfmt::skip]
fn wasmer_import_transfer_dcdt_execute(env: FunctionEnvMut<VMHooksWrapper>, dest_offset: i32, token_id_offset: i32, token_id_len: i32, value_offset: i32, gas_limit: i64, function_offset: i32, function_length: i32, num_arguments: i32, arguments_length_offset: i32, data_offset: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.transfer_dcdt_execute(convert_mem_ptr(dest_offset), convert_mem_ptr(token_id_offset), convert_mem_length(token_id_len), convert_mem_ptr(value_offset), gas_limit, convert_mem_ptr(function_offset), convert_mem_length(function_length), num_arguments, convert_mem_ptr(arguments_length_offset), convert_mem_ptr(data_offset)))
}

#[rustfmt::skip]
fn wasmer_import_transfer_dcdt_nft_execute(env: FunctionEnvMut<VMHooksWrapper>, dest_offset: i32, token_id_offset: i32, token_id_len: i32, value_offset: i32, nonce: i64, gas_limit: i64, function_offset: i32, function_length: i32, num_arguments: i32, arguments_length_offset: i32, data_offset: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.transfer_dcdt_nft_execute(convert_mem_ptr(dest_offset), convert_mem_ptr(token_id_offset), convert_mem_length(token_id_len), convert_mem_ptr(value_offset), nonce, gas_limit, convert_mem_ptr(function_offset), convert_mem_length(function_length), num_arguments, convert_mem_ptr(arguments_length_offset), convert_mem_ptr(data_offset)))
}

#[rustfmt::skip]
fn wasmer_import_multi_transfer_dcdt_nft_execute(env: FunctionEnvMut<VMHooksWrapper>, dest_offset: i32, num_token_transfers: i32, token_transfers_args_length_offset: i32, token_transfer_data_offset: i32, gas_limit: i64, function_offset: i32, function_length: i32, num_arguments: i32, arguments_length_offset: i32, data_offset: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.multi_transfer_dcdt_nft_execute(convert_mem_ptr(dest_offset), num_token_transfers, convert_mem_ptr(token_transfers_args_length_offset), convert_mem_ptr(token_transfer_data_offset), gas_limit, convert_mem_ptr(function_offset), convert_mem_length(function_length), num_arguments, convert_mem_ptr(arguments_length_offset), convert_mem_ptr(data_offset)))
}
...
#[rustfmt::skip]
fn wasmer_import_get_dcdt_value(env: FunctionEnvMut<VMHooksWrapper>, result_offset: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_dcdt_value(convert_mem_ptr(result_offset)))
}

#[rustfmt::skip]
fn wasmer_import_get_dcdt_value_by_index(env: FunctionEnvMut<VMHooksWrapper>, result_offset: i32, index: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_dcdt_value_by_index(convert_mem_ptr(result_offset), index))
}

#[rustfmt::skip]
fn wasmer_import_get_dcdt_token_name(env: FunctionEnvMut<VMHooksWrapper>, result_offset: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_dcdt_token_name(convert_mem_ptr(result_offset)))
}

#[rustfmt::skip]
fn wasmer_import_get_dcdt_token_name_by_index(env: FunctionEnvMut<VMHooksWrapper>, result_offset: i32, index: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_dcdt_token_name_by_index(convert_mem_ptr(result_offset), index))
}

#[rustfmt::skip]
fn wasmer_import_get_dcdt_token_nonce(env: FunctionEnvMut<VMHooksWrapper>) -> Result<i64, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_dcdt_token_nonce())
}

#[rustfmt::skip]
fn wasmer_import_get_dcdt_token_nonce_by_index(env: FunctionEnvMut<VMHooksWrapper>, index: i32) -> Result<i64, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_dcdt_token_nonce_by_index(index))
}

#[rustfmt::skip]
fn wasmer_import_get_current_dcdt_nft_nonce(env: FunctionEnvMut<VMHooksWrapper>, address_offset: i32, token_id_offset: i32, token_id_len: i32) -> Result<i64, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_current_dcdt_nft_nonce(convert_mem_ptr(address_offset), convert_mem_ptr(token_id_offset), convert_mem_length(token_id_len)))
}

#[rustfmt::skip]
fn wasmer_import_get_dcdt_token_type(env: FunctionEnvMut<VMHooksWrapper>) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_dcdt_token_type())
}

#[rustfmt::skip]
fn wasmer_import_get_dcdt_token_type_by_index(env: FunctionEnvMut<VMHooksWrapper>, index: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_dcdt_token_type_by_index(index))
}

#[rustfmt::skip]
fn wasmer_import_get_num_dcdt_transfers(env: FunctionEnvMut<VMHooksWrapper>) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_num_dcdt_transfers())
}
...
#[rustfmt::skip]
fn wasmer_import_managed_get_multi_dcdt_call_value(env: FunctionEnvMut<VMHooksWrapper>, multi_call_value_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_get_multi_dcdt_call_value(multi_call_value_handle))
}
...
#[rustfmt::skip]
fn wasmer_import_managed_get_back_transfers(env: FunctionEnvMut<VMHooksWrapper>, dcdt_transfers_value_handle: i32, rewa_value_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_get_back_transfers(dcdt_transfers_value_handle, rewa_value_handle))
}

#[rustfmt::skip]
fn wasmer_import_managed_get_dcdt_balance(env: FunctionEnvMut<VMHooksWrapper>, address_handle: i32, token_id_handle: i32, nonce: i64, value_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_get_dcdt_balance(address_handle, token_id_handle, nonce, value_handle))
}

#[rustfmt::skip]
fn wasmer_import_managed_get_dcdt_token_data(env: FunctionEnvMut<VMHooksWrapper>, address_handle: i32, token_id_handle: i32, nonce: i64, value_handle: i32, properties_handle: i32, hash_handle: i32, name_handle: i32, attributes_handle: i32, creator_handle: i32, royalties_handle: i32, uris_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_get_dcdt_token_data(address_handle, token_id_handle, nonce, value_handle, properties_handle, hash_handle, name_handle, attributes_handle, creator_handle, royalties_handle, uris_handle))
}

#[rustfmt::skip]
fn wasmer_import_managed_get_dcdt_token_type(env: FunctionEnvMut<VMHooksWrapper>, address_handle: i32, token_id_handle: i32, nonce: i64, type_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_get_dcdt_token_type(address_handle, token_id_handle, nonce, type_handle))
}
...
#[rustfmt::skip]
fn wasmer_import_managed_multi_transfer_dcdt_nft_execute(env: FunctionEnvMut<VMHooksWrapper>, dst_handle: i32, token_transfers_handle: i32, gas_limit: i64, function_handle: i32, arguments_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_multi_transfer_dcdt_nft_execute(dst_handle, token_transfers_handle, gas_limit, function_handle, arguments_handle))
}

#[rustfmt::skip]
fn wasmer_import_managed_multi_transfer_dcdt_nft_execute_with_return(env: FunctionEnvMut<VMHooksWrapper>, dst_handle: i32, token_transfers_handle: i32, gas_limit: i64, function_handle: i32, arguments_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_multi_transfer_dcdt_nft_execute_with_return(dst_handle, token_transfers_handle, gas_limit, function_handle, arguments_handle))
}

#[rustfmt::skip]
fn wasmer_import_managed_multi_transfer_dcdt_nft_execute_by_user(env: FunctionEnvMut<VMHooksWrapper>, user_handle: i32, dst_handle: i32, token_transfers_handle: i32, gas_limit: i64, function_handle: i32, arguments_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_multi_transfer_dcdt_nft_execute_by_user(user_handle, dst_handle, token_transfers_handle, gas_limit, function_handle, arguments_handle))
}
...
#[rustfmt::skip]
fn wasmer_import_managed_is_dcdt_frozen(env: FunctionEnvMut<VMHooksWrapper>, address_handle: i32, token_id_handle: i32, nonce: i64) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_is_dcdt_frozen(address_handle, token_id_handle, nonce))
}

#[rustfmt::skip]
fn wasmer_import_managed_is_dcdt_limited_transfer(env: FunctionEnvMut<VMHooksWrapper>, token_id_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_is_dcdt_limited_transfer(token_id_handle))
}

#[rustfmt::skip]
fn wasmer_import_managed_is_dcdt_paused(env: FunctionEnvMut<VMHooksWrapper>, token_id_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_is_dcdt_paused(token_id_handle))
}
...
#[rustfmt::skip]
fn wasmer_import_big_int_get_dcdt_call_value(env: FunctionEnvMut<VMHooksWrapper>, destination: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_int_get_dcdt_call_value(destination))
}

#[rustfmt::skip]
fn wasmer_import_big_int_get_dcdt_call_value_by_index(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32, index: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_int_get_dcdt_call_value_by_index(destination_handle, index))
}
...
#[rustfmt::skip]
fn wasmer_import_big_int_get_dcdt_external_balance(env: FunctionEnvMut<VMHooksWrapper>, address_offset: i32, token_id_offset: i32, token_id_len: i32, nonce: i64, result_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_int_get_dcdt_external_balance(convert_mem_ptr(address_offset), convert_mem_ptr(token_id_offset), convert_mem_length(token_id_len), nonce, result_handle))
}
...
pub fn generate_import_object(store: &mut Store, vh_wrapper: VMHooksWrapper) -> Imports {
    ...
    imports! {
        "env" => {
            ...
            "getDCDTBalance" => Function::new_typed_with_env(store, &function_env, wasmer_import_get_dcdt_balance),
            "getDCDTNFTNameLength" => Function::new_typed_with_env(store, &function_env, wasmer_import_get_dcdt_nft_name_length),
            "getDCDTNFTAttributeLength" => Function::new_typed_with_env(store, &function_env, wasmer_import_get_dcdt_nft_attribute_length),
            "getDCDTNFTURILength" => Function::new_typed_with_env(store, &function_env, wasmer_import_get_dcdt_nft_uri_length),
            "getDCDTTokenData" => Function::new_typed_with_env(store, &function_env, wasmer_import_get_dcdt_token_data),
            "getDCDTLocalRoles" => Function::new_typed_with_env(store, &function_env, wasmer_import_get_dcdt_local_roles),
            ...
            "transferDCDTExecute" => Function::new_typed_with_env(store, &function_env, wasmer_import_transfer_dcdt_execute),
            "transferDCDTNFTExecute" => Function::new_typed_with_env(store, &function_env, wasmer_import_transfer_dcdt_nft_execute),
            "multiTransferDCDTNFTExecute" => Function::new_typed_with_env(store, &function_env, wasmer_import_multi_transfer_dcdt_nft_execute),
            ...
            "getDCDTValue" => Function::new_typed_with_env(store, &function_env, wasmer_import_get_dcdt_value),
            "getDCDTValueByIndex" => Function::new_typed_with_env(store, &function_env, wasmer_import_get_dcdt_value_by_index),
            "getDCDTTokenName" => Function::new_typed_with_env(store, &function_env, wasmer_import_get_dcdt_token_name),
            "getDCDTTokenNameByIndex" => Function::new_typed_with_env(store, &function_env, wasmer_import_get_dcdt_token_name_by_index),
            "getDCDTTokenNonce" => Function::new_typed_with_env(store, &function_env, wasmer_import_get_dcdt_token_nonce),
            "getDCDTTokenNonceByIndex" => Function::new_typed_with_env(store, &function_env, wasmer_import_get_dcdt_token_nonce_by_index),
            "getCurrentDCDTNFTNonce" => Function::new_typed_with_env(store, &function_env, wasmer_import_get_current_dcdt_nft_nonce),
            "getDCDTTokenType" => Function::new_typed_with_env(store, &function_env, wasmer_import_get_dcdt_token_type),
            "getDCDTTokenTypeByIndex" => Function::new_typed_with_env(store, &function_env, wasmer_import_get_dcdt_token_type_by_index),
            "getNumDCDTTransfers" => Function::new_typed_with_env(store, &function_env, wasmer_import_get_num_dcdt_transfers),
            ...
            "managedGetMultiDCDTCallValue" => Function::new_typed_with_env(store, &function_env, wasmer_import_managed_get_multi_dcdt_call_value),
            ...
            "managedGetDCDTBalance" => Function::new_typed_with_env(store, &function_env, wasmer_import_managed_get_dcdt_balance),
            "managedGetDCDTTokenData" => Function::new_typed_with_env(store, &function_env, wasmer_import_managed_get_dcdt_token_data),
            "managedGetDCDTTokenType" => Function::new_typed_with_env(store, &function_env, wasmer_import_managed_get_dcdt_token_type),
            ...
            "managedMultiTransferDCDTNFTExecute" => Function::new_typed_with_env(store, &function_env, wasmer_import_managed_multi_transfer_dcdt_nft_execute),
            "managedMultiTransferDCDTNFTExecuteWithReturn" => Function::new_typed_with_env(store, &function_env, wasmer_import_managed_multi_transfer_dcdt_nft_execute_with_return),
            "managedMultiTransferDCDTNFTExecuteByUser" => Function::new_typed_with_env(store, &function_env, wasmer_import_managed_multi_transfer_dcdt_nft_execute_by_user),
            "managedTransferValueExecute" => Function::new_typed_with_env(store, &function_env, wasmer_import_managed_transfer_value_execute),
            "managedIsDCDTFrozen" => Function::new_typed_with_env(store, &function_env, wasmer_import_managed_is_dcdt_frozen),
            "managedIsDCDTLimitedTransfer" => Function::new_typed_with_env(store, &function_env, wasmer_import_managed_is_dcdt_limited_transfer),
            "managedIsDCDTPaused" => Function::new_typed_with_env(store, &function_env, wasmer_import_managed_is_dcdt_paused),
            ...
            "bigIntGetDCDTCallValue" => Function::new_typed_with_env(store, &function_env, wasmer_import_big_int_get_dcdt_call_value),
            "bigIntGetDCDTCallValueByIndex" => Function::new_typed_with_env(store, &function_env, wasmer_import_big_int_get_dcdt_call_value_by_index),
            "bigIntGetExternalBalance" => Function::new_typed_with_env(store, &function_env, wasmer_import_big_int_get_external_balance),
            "bigIntGetDCDTExternalBalance" => Function::new_typed_with_env(store, &function_env, wasmer_import_big_int_get_dcdt_external_balance),
