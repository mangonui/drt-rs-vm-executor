...
(module
    ...
    (func $_ZN11numbat_wasm2io16arg_nested_tuple15load_single_arg17hc323659743ed9ee4E (type 1) (result i32)
      (local i32)
      i32.const 0
      call $_ZN16numbat_wasm_node3api13managed_types19static_var_api_node11next_handle17hdafd854c2ac6d869E
      local.tee 0
      call $bigIntGetUnsignedArgument
      local.get 0)
    (func $_ZN16numbat_wasm_node3api13managed_types19static_var_api_node11next_handle17hdafd854c2ac6d869E (type 1) (result i32)
      (local i32)
      i32.const 0
      i32.const 0
      ...
      local.get 0)
    (func $_ZN11numbat_wasm2io16arg_nested_tuple22check_num_arguments_eq17h848f7f930a70d303E (type 6) (param i32)
      block  ;; label = @1
      ...
      call $signalError
      unreachable)
    (func $_ZN11numbat_wasm7storage7mappers19single_value_mapper31SingleValueMapper$LT$SA$C$T$GT$3get17h25bb7558615ec585E (type 7) (param i32) (result i32)
      (local i32)
      local.get 0
      call $_ZN16numbat_wasm_node3api13managed_types19static_var_api_node11next_handle17hdafd854c2ac6d869E
      local.tee 1
      ...
      drop
      local.get 0)
    (func $_ZN11numbat_wasm7storage7mappers19single_value_mapper31SingleValueMapper$LT$SA$C$T$GT$3set17h646573d1e8aedfb8E (type 0) (param i32 i32)
      (local i32)
      call $_ZN16numbat_wasm_node3api13managed_types19static_var_api_node11next_handle17hdafd854c2ac6d869E
      local.tee 2
      local.get 1
    ...
    (func $init (type 4)
      ...
      call $checkNoPayment
      i32.const 1
      call $_ZN11numbat_wasm2io16arg_nested_tuple22check_num_arguments_eq17h848f7f930a70d303E
      call $_ZN11numbat_wasm2io16arg_nested_tuple15load_single_arg17hc323659743ed9ee4E
      local.set 0
      call $_ZN34_$LT$C$u20$as$u20$adder..Adder$GT$3sum17h4be7469c9e0e8813E
      local.get 0
      call $_ZN11numbat_wasm7storage7mappers19single_value_mapper31SingleValueMapper$LT$SA$C$T$GT$3set17h646573d1e8aedfb8E)
    (func $add (type 4)
      (local i32 i32 i32)
      call $checkNoPayment
      i32.const 1
      ...
      call $_ZN34_$LT$C$u20$as$u20$adder..Adder$GT$3sum17h4be7469c9e0e8813E
      local.tee 1
      call $_ZN11numbat_wasm7storage7mappers19single_value_mapper31SingleValueMapper$LT$SA$C$T$GT$3get17h25bb7558615ec585E
      local.tee 2
      local.get 2
      local.get 0
      call $bigIntAdd
